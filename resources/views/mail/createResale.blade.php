                    ...
                    <tr style="border-collapse:collapse">
                        <td align="center" style="padding:0;Margin:0">
                            <table class="es-content-body"
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td style="padding:0;Margin:0;position:relative"
                                                                align="center"><a target="_blank"
                                                                                  href="{{env('APP_URL')}}"
                                                                                  style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#F09870;font-size:14px"><img
                                                                            class="adapt-img"
                                                                            src="{{asset('front/images/bureviy_mail.png')}}"
                                                                            alt="{{env('APP_NAME')}}"
                                                                            title="{{env('APP_NAME')}}" width="600"
                                ...
                                <tr style="border-collapse:collapse">
                                    <td align="left"
                                        style="Margin:0;padding-bottom:5px;padding-left:5px;padding-right:5px;padding-top:15px">
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td align="left" style="padding:0;Margin:0"><p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;line-height:21px;color:#333333;font-size:25px; text-align: center">
                                                                    <h2>{{$setting->textForMail}}</h2><br type="_moz"></p></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                ...
                                @foreach($products->chunk(3) as $chunks)
                                    ...
                                    <tr style="border-collapse:collapse">
                                        ...
                                        @foreach($chunks as $product)
                                            ...
                                            @if($loop->first)
                                                @include('mail.partialsMail.first_table')
                                            @endif

                                            @if($loop->iteration % 2 == 0)
                                                @include('mail.partialsMail.two_table')
                                            @endif
                                            @if( $loop->iteration % 3 == 0)
                                                @include('mail.partialsMail.three_table')
                                            @endif
                                        @endforeach
                                    </tr>
                            @endforeach
        ...
        <tr style="border-collapse:collapse">
            <td align="center" style="padding:0;Margin:0">
                <table class="es-footer-body" cellspacing="0" cellpadding="0" align="center"
                       style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;border-top:1px solid #cccccc;width:600px"
                       role="none">
                    <tr style="border-collapse:collapse">
                        <td align="left"
                                        ...
                                        <table width="100%" cellspacing="0" cellpadding="0"
                                            ...
                                            <tr style="border-collapse:collapse">
                                                <td align="center" style="padding:0;Margin:0"><p
                                                            style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;line-height:27px;color:#666666;font-size:13px">
                                                                    <span style="font-size:18px"><span
                                                                                style="font-family:georgia, serif;line-height:150%"></span></span>
                                                    </p></td>
                                            </tr>
                                            @php /** @var \App\Models\Setting $setting */ @endphp
                                            <tr style="border-collapse:collapse">
                                                <td align="center" style="padding:0;Margin:0"><p
                                                            style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;line-height:20px;color:#BBBBBB;font-size:13px">
                                                        <strong><span
                                                                    style="font-size:13px;line-height:20px">{{$setting->address}} ; {{$setting->phone}}</span></strong>
                                                    </p></td>
                                            </tr>
                                        </table>
                                    </td>
