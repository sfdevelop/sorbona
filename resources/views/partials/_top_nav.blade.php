    ...
    <div class="navbar-left">
        <div class="logo-area">
            <a class="navbar-brand" href="">
                <img style="height: 50px; min-width: 40px;  max-width: 100%" class="dark" src="{{asset('assets/img/foxic.jpeg')}}" alt="svg">
            </a>
...
{{--            </li>--}}
            <li class="nav-author">
                <div class="dropdown-custom">
                    <a href="javascript:;" class="nav-item-toggle">
                        <img src="{{ asset('front/images/dest/content/favicon.png') }}"
                             alt="" class="rounded-circle">

                            <span class="nav-item__title">Admin<i
                    ...
                    <div class="dropdown-wrapper">
                        <div class="nav-author__info">
                            ...
                            <div>
                                @if(Auth::check())
                                    <h6 class="text-capitalize">Admin</h6>
                                @endif
                                <span>Administrator</span>
                            </div>
                        </div>
                        @include('partials.main._dropDownRight')
                    </div>
                </div>
            </li>
        </ul>
