            ...
            <div class="col-lg-12">
                <div class="breadcrumb-main">
                    <h4 class="text-capitalize breadcrumb-title d-flex align-items-center">
                        <span class="mx-10"> {{__('admin.manufacturer')}}</span>
                        <x-create model="manufacturer"/>
                    </h4>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="table-actions">
                                                    <x-edit-in-table model="manufacturer" :id="$item->id"/>

                                                    <x-delete-in-table model="manufacturer" :id="$item->id"/>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
