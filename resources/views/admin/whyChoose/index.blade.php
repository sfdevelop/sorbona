            ...
            <div class="col-lg-12">
                <div class="breadcrumb-main">
                    <h4 class="text-capitalize breadcrumb-title d-flex align-items-center">
                        <span class="mx-10"> {{__('admin.whyChoose')}}</span>
{{--                        <x-create model="whyChoose"/>--}}
                    </h4>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="author-info">
                                                    <img
                                                            style="max-width: 60px; background: #333"
                                                            src="{{$item->img_original}}"
                                                         alt="admin author">
                                                </span>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="table-actions">
                                                    <x-edit-in-table model="whyChoose" :id="$item->id"/>

{{--                                                    <x-delete-in-table model="whyChoose" :id="$item->id"/>--}}
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
