...
class WhyChoose extends Model implements HasMedia, TranslatableContract
{
    ...
    private static string $imageCollectionName = 'whyChoose';

    private static string $noImage = '/img/whyChose.png';
