...
class Chose extends Model implements HasMedia, TranslatableContract
{
    ...
    private static string $imageCollectionName = 'chose';

    private static string $noImage = '/img/chose.png';
