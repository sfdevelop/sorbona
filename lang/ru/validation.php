...
return [
    ...
    'after_or_equal' => 'В поле :attribute должна быть дата больше или равна :date.',
    ...
    'gte' => [
        ...
        'file' => 'Размер файла в поле :attribute должен быть :value Килобайт(а) или более.',
    ...
    'numeric' => 'Поле :attribute должно быть числом. Так же разделитель должен быть точкой',
    ...
    'same' => 'Значение полей :attribute и :other должны совпадать.',
    'size' => [
    ...
    'uploaded' => 'Загрузка поля :attribute не удалось.',
    ...
    'attributes' => [
        ...
        'years' => 'Год',
        'title_two' => 'Название',
        'description_two' => 'Описание',
        'contacts' => 'Раздел контактов',
        'leftBlock' => 'Левый блок',
        'rightBlock' => 'Правый блок',
        'rating' => 'Рейтинг',
        'comment' => 'Комментарий',
        ...
        'map' => 'Карта',
        'category_photo_id' => 'Категория для фото',
        'quote' => 'Цитата',
        ...
        'index' => 'Индекс',
        'selectedNpCity' => 'Город',
        'selectedNpDepot' => 'Отделение',
        'companyName' => 'Название',
        'inn' => 'ИНН',
        'edrpou' => 'ЕГРПОУ',
        'login' => 'E-mail ли телефон',
    ],
];
