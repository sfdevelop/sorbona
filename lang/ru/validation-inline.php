...
return [
    ...
    'active_url' => 'Недействительная URL.',
    'after' => 'Дата должна быть больше :date.',
    'after_or_equal' => 'Дата должна быть больше или равняться :date.',
    'alpha' => 'Тут могут быть только буквы.',
    'alpha_dash' => 'Тут могут быть только буквы, цифры, дефис и нижнее подчеркивание.',
    'alpha_num' => 'Тут могут быть только буквы и цифры.',
    'array' => 'Тут должен быть массив.',
    'attached' => 'Уже установлено.',
    ...
    'image' => 'Тут должно быть изображение.',
    'in' => 'Избранное значение ошибочно.',
    ...
    'starts_with' => 'Значение должно начинаться с одного из следующих значений: :values',
    'string' => 'Тут должна быть строка.',
